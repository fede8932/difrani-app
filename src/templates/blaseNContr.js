      ...
      <div class="encabezado">
        ...
        <div class="dataFact">
          <div class="factCont">
            ...
            <div class="numberFact"><span>${controlOrder.id}</span></div>
          </div>
          <div class="fechaFact">FECHA: ${fechaConverter(
            controlOrder.createdAt
          )}</div>
        </div>
      </div>
      <div class="clientContainer">
        <div class="ivaClient">
          <span class="clientInfoText">Proveedor: <span class="clientInfoTextDos">${
            controlOrder.purchaseOrder.supplier.razonSocial
          }</span></span>
          <span class="clientInfoText">Orden de compra: <span class="clientInfoTextDos">${
            controlOrder.purchaseOrder.numero
          }</span></span>
        </div>
        <div class="ivaClient">
