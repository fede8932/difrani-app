...
function BrandPaymentDiscountComponent(props) {
  const {
    methods,
    newDiscount,
    deleteDiscount,
    ...
    <div>
      ...
      >
        <span>
          ...
          <span className={styles.selectArticle}>{brand?.code}</span>
        </span>
        <span>
          <i className="fa-solid fa-magnifying-glass-chart"></i>
          <span className={styles.selectArticle}>{brand?.name}</span>
        </span>
      </div>
...
export default BrandPaymentDiscountComponent;
